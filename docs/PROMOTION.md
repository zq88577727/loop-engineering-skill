...
```text
I released Loop Engineering v0.4.3, a workflow pack for turning vague ideas into
...
```text
我发布了 Loop Engineering v0.4.3。它现在不只是 Codex skill，而是一个可复用的
...
```text
1. Install the skill from the pinned v0.4.3 tag.
2. Restart Codex.
